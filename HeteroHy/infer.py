...
from model import PCVRHyFormerHetero as PCVRHyFormer, ModelInput
...
_FALLBACK_MODEL_CFG = {
    ...
    'user_ns_tokens': 0,
    'item_ns_tokens': 0,
    # === HeteroFormer 融合参数（新增）===
    'ns_interaction_rank': 32,
    'ns_interaction_banks': 4,
    'use_ns_triplet_enhancer': True,
    'use_hetero_cross_attn': True,
    'hetero_kernel_size': 3,
    'use_highway_mixer': True,
}
